...
import static com.testblaze.misclib.ConsoleFormatter.COLOR.RED;
import static com.testblaze.misclib.ConsoleFormatter.ICON.X_MARK;
...
public final class FindMyElements {
    ...
    public WebElement getElement(By locator, Boolean enablePreProcessing) {
        ...
        if (enablePreProcessing) {
            try {
                ...
                i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_ERROR, RED, X_MARK, "Element is not present or locator is not correct | " + refinedFinalLocator);
                throw e;
            }
        } else {
            try {
    ...
    public WebElement getNestedElement(WebElement element, By locator, Boolean enablePreProcessing) {
        ...
        if (enablePreProcessing) {
            try {
                ...
                i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_ERROR, "Nested Element is not present or locator is not correct | " + refinedFinalLocator);
                throw e;
            }
        } else {
            try {
    ...
    public List<WebElement> getElements(By locator, Boolean enablePreProcessing) {
        ...
        if (enablePreProcessing) {
            try {
                ...
                i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_ERROR, "List of Elements is not present or locator is not correct | " + refinedFinalLocator);
                throw e;
            }
        } else {
            try {
                ...
                i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_ERROR, "List of Elementss is not present or locator is not correct | " + refinedFinalLocator);
                throw e;
            }
        }
    }
    ...
    public List<WebElement> getNestedElementList(WebElement element, By locator) {
        ...
        try {
            ...
            i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_ERROR, "Element is not present or locator is not correct | " + refinedFinalLocator);
            throw e;
        }
    }
    ...
    public Select getDropDown(By locator, Boolean enablePreProcessing) {
        ...
        if (enablePreProcessing) {
            try {
                ...
                i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_ERROR, "Element is not present or locator is not correct | " + locator);
                throw e;
            }
        } else {
            try {
    ...
    public Select getDropDown(WebElement element) {
        try {
            ...
            i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_ERROR, "Element is not present or locator is not correct | " + element);
            throw e;
        }
    }
}
