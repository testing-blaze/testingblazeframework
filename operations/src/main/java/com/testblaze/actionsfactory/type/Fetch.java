...
import com.testblaze.misclib.KeysHandler;
...
public final class Fetch {
    ...
    public void ToUrl(String url) {
        ...
        i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_INFO, "Navigated to URL " + url);
    }
    ...
    public void navigateBack() {
        ...
        i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_INFO, "Navigated Back");
    }
    ...
    public void navigateForward() {
        ...
        i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_INFO, "Navigated Forward");
    }
    ...
    public void pageRefresh() {
        ...
        i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_INFO, "Refreshed page");
    }
    ...
    public void newURL(String url) {
        driver.get(url);
        i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_INFO, "Entered URL " + url);
    }
    ...
    public String pageTitle() {
        i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_INFO, "Fetched title " + driver.getTitle());
    ...
    public String pageSource() {
        i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_INFO, "Fetching complete page source");
    ...
    public String currentURL() {
        i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_INFO, "Current url is " + driver.getCurrentUrl());
    ...
    public String dateWithOffsetFromGivenDate(String date, int offset, DateTimeFormatter formatter) {
        ...
        i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_INFO, "Fetched date is : " + receivedDate);
        return receivedDate;
    }
    ...
    public void closeBrowserOrTab() {
        i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_INFO, "Closed Tab " + driver.getTitle());
        driver.close();
    }
