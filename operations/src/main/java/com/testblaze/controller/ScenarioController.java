...
import static com.testblaze.misclib.ConsoleFormatter.ICON.CLOCK;
import static com.testblaze.misclib.ConsoleFormatter.ICON.TICK;
...
public class ScenarioController {
    ...
    static void printFinalLogs() {
        ...
        i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_INFO, GREEN, CLOCK, "Scenario Result Analysis:");
    ...
    static void setTotalNumberOfScenarios() {
        try {
            ...
            i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_ERROR,
