...
public final class AppiumController {
    ...
    public static void startServer() {
        ...
        service = new AppiumServiceBuilder()
                ...
                .build();
        service.start();
        i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_INFO, "Appium Server is running: " + service.isRunning());
    }
    ...
    private static void killPort() {
        try {
            ...
            i.amPerforming().updatingReportWith().write(LogLevel.TEST_BLAZE_INFO, "Socket closed");
        }
    }
}
