 ...
 * under the License.
 */
package com.fast.actionsfactory.elementfunctions;
...
import com.fast.mobile.Android;
import com.fast.mobile.IOS;
...
public final class Mobile {
    ...
    private WebElement getMobileElement(String locatorWithType, Boolean processing) {
        ...
        if (fetchElement == null)
            throw new FastRunTimeException("Mobile element is not present or incorrect: " + refinedLocator);
        return fetchElement;
    }
    ...
    private AppiumDriver<WebElement> driver() {
        if (!"android".equalsIgnoreCase(EnvironmentFetcher.getDevice())
            ...
            throw new FastRunTimeException("In order to use 'Mobile' library, System parameter 'device' must be set to 'android' or 'ios'.\n" +
