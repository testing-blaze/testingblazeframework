...
import com.fast.actionsfactory.processing.ExecuteClickProcessing;
...
import static com.fast.misclib.ConsoleFormatter.COLOR.BRIGHT_GREEN;
import static com.fast.misclib.ConsoleFormatter.COLOR.RED;
...
public class ExecuteCoreActions implements Action {
    ...
    public void doIt(WebElement element) {
        clickProcessingController.preProcessingFast.perform();
        ...
        clickProcessingController.postProcessingFast.perform();
    }
